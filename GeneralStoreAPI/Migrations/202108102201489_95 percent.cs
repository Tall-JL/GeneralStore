namespace GeneralStoreAPI.Migrations
{
    ...
    public partial class _95percent : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Transactions", "Product_SKU", "dbo.Products");
            DropForeignKey("dbo.Customers", "Transaction_TransactionId", "dbo.Transactions");
            DropForeignKey("dbo.Transactions", "Id", "dbo.Customers");
            ...
            DropIndex("dbo.Transactions", new[] { "Product_SKU" });
